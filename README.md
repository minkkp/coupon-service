...
Redis + Lua를 활용해 대규모 요청 환경에서 한정 수량 쿠폰을 정확하게 제어하고,  
AWS EC2 환경에 Docker 기반으로 배포하여 Blue/Green 무중단 배포와  
Prometheus·Grafana 기반 모니터링까지 구성한 프로젝트입니다.
<br><br>
...
- 쿠폰 과발급 / 중복 발급 방지
- 운영 환경을 가정한 무중단 배포 및 모니터링 구성 경험
<br><br>
...
## 🚀 배포 및 운영 경험
운영 환경을 가정하여 배포 자동화, 무중단 배포, 모니터링까지 구성했습니다.  
...
Redis의 원자 연산과 Lua 스크립트를 활용한 선착순 제어,  
Blue/Green 무중단 배포, Prometheus 기반 모니터링 구성 경험을 통해  
실무 환경에 가까운 백엔드 시스템을 설계하고 운영하는 과정을 직접 경험했습니다.
<br><br>
